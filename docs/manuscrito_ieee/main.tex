...
\author{
\IEEEauthorblockN{1\textsuperscript{st} Manuel Francisco Jamba}
\IEEEauthorblockA{\textit{Departamento de Ciências Exactas e Naturais} \\
\textit{Instituto Superior de Ciências da Educação da Huíla}\\
Lubango, Angola \\
m251295@isced-huila.edu.ao}
\and
\IEEEauthorblockN{2\textsuperscript{nd} Pedro Mussungo NGalangue}
\IEEEauthorblockA{\textit{Departamento de Ciências Exactas e Naturais} \\
\textit{Instituto Superior de Ciências da Educação da Huíla}\\
Lubango, Angola \\
m251300@isced-huila.edu.ao}
\and
\IEEEauthorblockN{3\textsuperscript{rd} Patrocínio Ndala Kambinda Ntyamba}
\IEEEauthorblockA{\textit{Departamento de Ciências Exactas e Naturais} \\
\textit{Instituto Superior de Ciências da Educação da Huíla}\\
Lubango, Angola \\
m251324@isced-huila.edu.ao}
\and
\IEEEauthorblockN{4\textsuperscript{th} Mpeheyo Branco Pacheco Himi}
\IEEEauthorblockA{\textit{Departamento de Ciências Exactas e Naturais} \\
\textit{Instituto Superior de Ciências da Educação da Huíla}\\
Lubango, Angola \\
m251298@isced-huila.edu.ao}
\and
\IEEEauthorblockN{5\textsuperscript{th} Nelson de Jesus Henriques Ngonga}
\IEEEauthorblockA{\textit{Departamento de Ciências Exactas e Naturais} \\
\textit{Instituto Superior de Ciências da Educação da Huíla}\\
Lubango, Angola \\
m251299@isced-huila.edu.ao}
\and
\IEEEauthorblockN{6\textsuperscript{th} Mateus Sacuyema Morais}
\IEEEauthorblockA{\textit{Departamento de Ciências Exactas e Naturais} \\
\textit{Instituto Superior de Ciências da Educação da Huíla}\\
Lubango, Angola \\
m251297@isced-huila.edu.ao}
\and
\IEEEauthorblockN{7\textsuperscript{th} Sávio Panzo Costa Ivo}
\IEEEauthorblockA{\textit{Departamento de Ciências Exactas e Naturais} \\
\textit{Instituto Superior de Ciências da Educação da Huíla}\\
Lubango, Angola \\
m251217@isced-huila.edu.ao}
\and
\IEEEauthorblockN{8\textsuperscript{th} Marcelino Galvino Thikanha Júlio}
\IEEEauthorblockA{\textit{Departamento de Ciências Exactas e Naturais} \\
\textit{Instituto Superior de Ciências da Educação da Huíla}\\
Lubango, Angola \\
m251296@isced-huila.edu.ao}
}
...
\begin{IEEEkeywords}
Álgebra Linear, Laboratório Digital, Ensino Superior, Streamlit, Plotly, Registos de Representação Semiótica, ISCED-Huíla
\end{IEEEkeywords}
...
\subsubsection{Módulo M1 --- Álgebra de Matrizes}
...
\subsubsection{Módulo M2 --- Determinantes e Interpretação Geométrica}
Calcula o determinante $\det(A)$ para matrizes quadradas de ordem $n \geq 2$:
\begin{equation}
...
\subsubsection{Módulo M3 --- Inversão de Matrizes}
...
\subsubsection{Módulo M4 --- Sistemas de Equações Lineares}
...
\subsubsection{Módulo M5 --- Geometria Vectorial}
...
\subsubsection{Módulo M6 --- Valores e Vectores Próprios}
...
\bibitem{duval1995} R. Duval, \textit{Sémiosis et pensée humaine: Registres sémiotiques et apprentissages intellectuels}. Bern: Peter Lang, 1995.
\bibitem{tall2004} D. Tall, ``Building theories: The three worlds of mathematics,'' \textit{For the Learning of Mathematics}, vol. 24, no. 1, pp. 29--32, 2004.
\bibitem{singh2021} G. Singh, N. Tuli, and A. Mantri, ``Issues and challenges in learning foundation linear algebra course with technology: A literature review,'' in \textit{2021 International Conference on Advance Computing and Innovative Technologies in Engineering (ICACITE)}, 2021, pp. 860--865.
\bibitem{moro2016} G. Moro, F. A. V. Viseu, e I. Z. Siple, ``Ensino de Álgebra linear: Traços de uma pesquisa,'' em \textit{Anais do II COLBEDUCA -- Colóquio Luso-Brasileiro de Educação}, Joinville, Brasil, 2016, pp. 243--256.
\bibitem{damiano2025} M. S. Damiano e R. F. Ivo, ``CG.lab: desenvolvimento e avaliação de uma plataforma interativa para apoio no ensino de álgebra linear aplicada à computação gráfica,'' em \textit{Anais do XXXVI Simpósio Brasileiro de Informática na Educação (SBIE 2025)}, 2025, pp. 1685--1693.
\bibitem{hohenwarter2004} M. Hohenwarter and K. J. Fuchs, ``Combination of dynamic geometry, algebra and calculus in the software system GeoGebra,'' em \textit{Proc. Sprout-Selecting Conf.}, 2004, pp. 128--133.
\bibitem{gladcheff2001} A. P. Gladcheff, ``Um instrumento de avaliação da qualidade para software educacional de matemática,'' Dissertação de Mestrado, Instituto de Matemática e Estatística, Universidade de São Paulo, São Paulo, 2001.
\bibitem{oliveira2001} N. de Oliveira, ``Uma proposta para a avaliação de software educacional,'' Dissertação de Mestrado, Universidade Federal de Santa Catarina, Florianópolis, 2001.
\bibitem{bardin2016} L. Bardin, \textit{Análise de conteúdo}. Lisboa: Edições 70, 2016.
\bibitem{araujo2024} J. P. de Araújo, ``Laboratório virtual de matemática: possibilidades para uma prática docente mediada por recursos digitais,'' Dissertação de Mestrado, Universidade Federal do Rio Grande do Norte, Natal, 2024.
\end{thebibliography}
